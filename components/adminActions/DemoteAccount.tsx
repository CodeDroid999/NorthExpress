            ...
            {isFormOpen && (
               ...
               flex-row justify-between`}
                        ...
                        <div className="mb-10 mt-5 text-base font-medium text-black">
                            <p>Are you sure you want to demote the account?</p>
                        </div>
                        <div className="flex w-full flex-row space-x-4">
                            <button
                                onClick={() => setIsFormOpen(false)}
                                className="flex-1  bg-gray-200 px-2 py-1.5 text-center font-medium text-red-700"
                            >
                                Back
                            </button>
                            <button
                                onClick={DemoteAccount}
                                className="flex-1  bg-red-600 px-2 py-1.5 text-center font-medium text-white"
                            >
                                Demote
                            </button>
                        </div>
