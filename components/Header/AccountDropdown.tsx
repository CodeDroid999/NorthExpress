...
const AccountDropdown = () => {
    ...
    return (
        <div className="relative">
            <div
                className="flex items-center justify-center rounded-full bg-primary px-2.5 py-2.5 text-regular text-white duration-300 ease-in-out hover:bg-primaryho"
                onClick={handleDropdown}
            >
                <span className="mr-2">Account</span>
                <div className=" border border-white ml-2 p-1" style={{ borderRadius: '50%' }}>
                    <FaUser />
                </div>
